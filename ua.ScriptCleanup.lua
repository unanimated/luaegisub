...
{x=4,y=0,class="label",label="  "},

{x=5,y=0,width=2,class="checkbox",name="allcol",label="Remove all colour tags"},
{x=5,y=1,class="checkbox",name="allphas",label="Remove all alphas"},
{x=6,y=1,class="checkbox",name="alpha14",label="Only 1a-4a"},
{x=5,y=2,class="checkbox",name="allrot",label="Remove all rotations",hint="frx, fry, frz"},
{x=6,y=2,class="checkbox",name="xyrot",label="Only x, y",hint="remove frx, fry"},
{x=5,y=3,class="checkbox",name="allsize",label="Remove size/scaling",hint="fs, fscx, fscy"},
{x=6,y=3,class="checkbox",name="scales",label="Only scaling",hint="remove fscx, fscy"},
{x=5,y=4,class="checkbox",name="allshad",label="Remove all shadows",hint="shad, xshad, yshad"},
{x=6,y=4,class="checkbox",name="xyshad",label="Only x, y",hint="remove xshad, yshad"},
{x=5,y=5,class="checkbox",name="parent",label="Remove parentheses",hint="fad(e), (i)clip, pos, move, org\n(but not t)"},
{x=6,y=5,class="checkbox",name="parent2",label="Except \\pos",hint="fad(e), (i)clip, move, org\n(but not t or pos)"},
{x=5,y=6,width=2,class="checkbox",name="allpers",label="Remove all perspective",hint="frx, fry, frz, fax, fay, org"},

{x=5,y=7,width=2,class="label",label="      ~  Script Cleanup v5.0.0  ~"},

{x=5,y=8,width=2,class="checkbox",name="hspace",label="Remove hard spaces - \\h"},
{x=5,y=9,class="checkbox",name="nobreak",label="Remove line breaks"},
{x=6,y=9,class="checkbox",name="nobreak2",label="...no space",hint="Remove line breaks, leave no spaces"},
{x=5,y=10,class="checkbox",name="nostyle",label="Delete unused styles"},
{x=6,y=10,class="checkbox",name="nostyle2",label="Except Def.",hint="Delete unused styles except Default"},
{x=5,y=11,class="checkbox",name="inline",label="Remove inline tags"},
{x=6,y=11,class="checkbox",name="inline2",label="Except last",hint="Remove inline tags except the last one"},
{x=5,y=12,width=2,class="checkbox",name="nocom",label="Remove comments from lines",hint="Removes {comments} (not tags)"},
{x=5,y=13,width=2,class="checkbox",name="notag",label="Remove all {\\tags} from selected lines"},

{x=0,y=15,width=3,class="label",label="  ~  Script Cleanup v"..script_version.."  ~  "},
{x=5,y=15,class="checkbox",label="ver. info"},
...
{x=7,y=0,height=20,class="label",label="|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|"},

{x=8,y=0,class="checkbox",name="skill",label="[start]",value=true},
{x=9,y=0,class="checkbox",name="ikill",label="[inline]",value=true,hint="only kill, not hide"},
{x=10,y=0,width=2,class="checkbox",name="inverse",label="[inverse/unhide]",hint="kill all except checked ones\n\n'Unhide' for 'Hide Tags'"},
{x=10,y=1,width=2,class="checkbox",name="onlyt",label="[from \\t]",hint="remove only from transforms\n\n n/a for 'Hide Tags'"},

{x=8,y=1,class="checkbox",name="blur",label="blur"},
{x=8,y=2,class="checkbox",name="border",label="bord",hint="includes xbord and ybord [not for Hide]"},
{x=8,y=3,class="checkbox",name="shadow",label="shad",hint="includes xshad and yshad for Hide"},
{x=8,y=4,class="checkbox",name="fsize",label="fs"},
{x=8,y=5,class="checkbox",name="fspace",label="fsp"},
{x=8,y=6,class="checkbox",name="scalex",label="fscx"},
{x=8,y=7,class="checkbox",name="scaley",label="fscy"},
{x=8,y=8,class="checkbox",name="fname",label="fn"},
{x=8,y=9,class="checkbox",name="ital",label="i"},
{x=8,y=10,class="checkbox",name="bold",label="b"},
{x=8,y=11,class="checkbox",name="under",label="u"},
{x=8,y=12,class="checkbox",name="stri",label="s"},
{x=8,y=13,class="checkbox",name="wrap",label="q"},
{x=8,y=14,class="checkbox",name="mask",label="p"},

{x=9,y=1,class="checkbox",name="bee",label="be"},
{x=9,y=2,class="checkbox",name="color1",label="c, 1c"},
{x=9,y=3,class="checkbox",name="color2",label="2c"},
{x=9,y=4,class="checkbox",name="color3",label="3c"},
{x=9,y=5,class="checkbox",name="color4",label="4c"},
{x=9,y=6,class="checkbox",name="alpha",label="alpha"},
{x=9,y=7,class="checkbox",name="alfa1",label="1a"},
{x=9,y=8,class="checkbox",name="alfa2",label="2a"},
{x=9,y=9,class="checkbox",name="alfa3",label="3a"},
{x=9,y=10,class="checkbox",name="alfa4",label="4a"},
{x=9,y=11,class="checkbox",name="align",label="a"},
{x=9,y=12,class="checkbox",name="anna",label="an"},
{x=9,y=13,class="checkbox",name="clip",label="(i)clip"},

{x=10,y=2,class="checkbox",name="fade",label="fad"},
{x=10,y=3,class="checkbox",name="posi",label="pos"},
{x=10,y=4,class="checkbox",name="move",label="move"},
{x=10,y=5,class="checkbox",name="org",label="org"},
{x=10,y=6,class="checkbox",name="frz",label="frz"},
{x=10,y=7,class="checkbox",name="frx",label="frx"},
{x=10,y=8,class="checkbox",name="fry",label="fry"},
{x=10,y=9,class="checkbox",name="fax",label="fax"},
{x=10,y=10,class="checkbox",name="fay",label="fay"},
{x=10,y=11,width=2,class="checkbox",name="kara",label="k/kf/ko"},
{x=10,y=12,class="checkbox",name="return",label="r"},
{x=10,y=13,class="checkbox",name="trans",label="t"},

{x=11,y=12,height=2,class="checkbox",name="hidline",label="hide\ninline",hint='Hide ALL inline tags'},
}
	P,res=ADD(GUI,
